...
public abstract class ReportRegistService extends AbstractChapterSceneService {
	...
	protected abstract AfterSceneResultDto selectDateAfter(LinePostInfoDto lineInfo, UserEntity userInfo);
	
	protected abstract List<Message> inputReport(LinePostInfoDto lineInfo);
	
	protected abstract AfterSceneResultDto inputReportAfter(LinePostInfoDto lineInfo, UserEntity userInfo);
	
	protected abstract List<Message> confrimReport(LinePostInfoDto lineInfo);
	
	protected abstract AfterSceneResultDto confrimReportAfter(LinePostInfoDto lineInfo, UserEntity userInfo);
